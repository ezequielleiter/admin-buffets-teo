      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        ...
        <header className="h-20 border-b border-gray-200 bg-white flex items-center justify-between px-8 py-4 sticky top-0 z-10">
          <div className="flex items-center gap-4">
            <h2 className="text-lg font-bold text-text-primary">Gestión de Promociones</h2>
          </div>
          <button
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              {promos.length === 0 ? (
                <div className="p-12 text-center">
                  <span className="material-symbols-outlined text-text-secondary text-6xl mb-4">sell</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                  {promos.map((promo) => (
                    <div key={promo._id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
