      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        ...
        <header className="h-20 border-b border-gray-200 bg-white flex items-center justify-between px-8 py-4 sticky top-0 z-10">
          <div className="flex items-center gap-4">
            <h2 className="text-lg font-bold text-text-primary">Gestión de Eventos</h2>
          </div>
          <button
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              {eventos.length === 0 ? (
                <div className="p-12 text-center">
                  <span className="material-symbols-outlined text-text-secondary text-6xl mb-4">calendar_today</span>
                ...
                <div className="divide-y divide-gray-200">
                  {eventos.map((evento) => (
                    <div key={evento._id} className="p-6 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-2 bg-primary text-white text-xs font-medium rounded-lg hover:bg-accent-blue transition-colors flex items-center gap-1"
                          >
                          ...
                          <button 
                            ...
                            className="p-2 text-accent-orange hover:text-accent-orange-intense rounded-lg hover:bg-red-50 transition-colors"
                          >
